...
namespace sotoba::math::quaternion_impl {
	...
	struct Quaternion final {
		...
		friend constexpr auto operator*(const Quaternion& p, const Quaternion<is_unit2_>& q) noexcept
...
namespace sotoba::math {
	...
	struct ApproxCheckImpl<QuaternionT<u>> {
		static auto compare(const QuaternionT<u>& q1, const QuaternionT<u>& q2, const std::optional<float> eps) -> bool {
